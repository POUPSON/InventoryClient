...
public class InventoryService {
    public static PagedResponse<Item> getItems(int limit) throws IOException, InterruptedException {
    ...
    public static PagedResponse<Item> getItems() throws IOException, InterruptedException {
